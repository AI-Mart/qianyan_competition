...
parser.add_argument("--output_file", type=str, required=True, help="The full path of input file")
...
def predict(model, data_loader):
    """
    Predicts the datas labels.

    Args:
        model (obj:`SemanticIndexBase`): A model to extract text embedding or calculate similarity of text pair.
        data_loaer (obj:`List(Example)`): The processed datas ids of text pair: [query_input_ids, query_token_type_ids, title_input_ids, title_token_type_ids]
    Returns:
